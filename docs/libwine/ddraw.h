...
{
    /*** IUnknown methods ***/
    STDMETHOD_(HRESULT,QueryInterface)(THIS_ REFIID riid, void** ppvObject) PURE; /* 0x00 */
    STDMETHOD_(ULONG,AddRef)(THIS) PURE; /* 0x04 */
    STDMETHOD_(ULONG,Release)(THIS) PURE; /* 0x08 */
    /*** IDirectDraw methods ***/
    STDMETHOD(Compact)(THIS) PURE; /* 0x0c */
    STDMETHOD(CreateClipper)(THIS_ DWORD flags, IDirectDrawClipper **clipper, IUnknown *outer) PURE; /* 0x10 */
    STDMETHOD(CreatePalette)(THIS_ DWORD flags, PALETTEENTRY *color_table,
            IDirectDrawPalette **palette, IUnknown *outer) PURE; /* 0x14 */
    STDMETHOD(CreateSurface)(THIS_ DDSURFACEDESC *surface_desc,
            struct IDirectDrawSurface **surface, IUnknown *outer) PURE; /* 0x18 */
    STDMETHOD(DuplicateSurface)(THIS_ struct IDirectDrawSurface *src_surface,
            struct IDirectDrawSurface **dst_surface) PURE; /* 0x1c */
    STDMETHOD(EnumDisplayModes)(THIS_ DWORD flags, DDSURFACEDESC *surface_desc,
            void *ctx, LPDDENUMMODESCALLBACK cb) PURE; /* 0x20 */
    STDMETHOD(EnumSurfaces)(THIS_ DWORD flags, DDSURFACEDESC *surface_desc,
            void *ctx, LPDDENUMSURFACESCALLBACK cb) PURE; /* 0x24 */
    STDMETHOD(FlipToGDISurface)(THIS) PURE; /* 0x28 */
    STDMETHOD(GetCaps)(THIS_ DDCAPS *driver_caps, DDCAPS *hel_caps) PURE; /* 0x2c */
    STDMETHOD(GetDisplayMode)(THIS_ DDSURFACEDESC *surface_desc) PURE; /* 0x30 */
    STDMETHOD(GetFourCCCodes)(THIS_ LPDWORD lpNumCodes, LPDWORD lpCodes) PURE; /* 0x34 */
    STDMETHOD(GetGDISurface)(THIS_ struct IDirectDrawSurface **surface) PURE; /* 0x38 */
    STDMETHOD(GetMonitorFrequency)(THIS_ LPDWORD lpdwFrequency) PURE; /* 0x3c */
    STDMETHOD(GetScanLine)(THIS_ LPDWORD lpdwScanLine) PURE; /* 0x40 */
    STDMETHOD(GetVerticalBlankStatus)(THIS_ BOOL *lpbIsInVB) PURE; /* 0x44 */
    STDMETHOD(Initialize)(THIS_ GUID *lpGUID) PURE; /* 0x48 */
    STDMETHOD(RestoreDisplayMode)(THIS) PURE; /* 0x4c */
    STDMETHOD(SetCooperativeLevel)(THIS_ HWND hWnd, DWORD dwFlags) PURE; /* 0x50 */
    STDMETHOD(SetDisplayMode)(THIS_ DWORD dwWidth, DWORD dwHeight, DWORD dwBPP) PURE; /* 0x54 */
    STDMETHOD(WaitForVerticalBlank)(THIS_ DWORD dwFlags, HANDLE hEvent) PURE; /* 0x58 */
};
#undef INTERFACE
